...
class Course(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE, verbose_name=u"讲师", null=True, blank=True, help_text=f'{settings.MAIN_DISPLAY}__name')
...
class Video(models.Model):
    ...
    lesson = models.ForeignKey(Lesson, on_delete=models.CASCADE, verbose_name=u"章节", help_text=f'{settings.MAIN_DISPLAY}__name')
