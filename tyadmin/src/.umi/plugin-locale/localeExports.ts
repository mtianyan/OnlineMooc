...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/Users/mtianyan/tyRepos/Python/OnlineMooc/tyadmin/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/Users/mtianyan/tyRepos/Python/OnlineMooc/tyadmin/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from '/Users/mtianyan/tyRepos/Python/OnlineMooc/tyadmin/node_modules/react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/mtianyan/tyRepos/Python/OnlineMooc/tyadmin/src/locales/en-US.js')),
    },
    locale: 'en-US',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/mtianyan/tyRepos/Python/OnlineMooc/tyadmin/src/locales/pt-BR.js')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/mtianyan/tyRepos/Python/OnlineMooc/tyadmin/src/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/mtianyan/tyRepos/Python/OnlineMooc/tyadmin/src/locales/zh-TW.js')),
    },
    locale: 'zh-TW',
    antd: {
