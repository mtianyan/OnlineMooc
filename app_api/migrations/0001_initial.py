# Generated by Django 3.1.2 on 2020-10-25 22:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', tyadmin_api_cli.fileds.SImageField(default='', max_length=255, upload_to='', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', tyadmin_api_cli.fileds.SImageField(default='', max_length=255, upload_to='Comment_avatar', verbose_name='评论头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Read_img', verbose_name='图片')),
                ('detailImg', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Read_detail', verbose_name='细节图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Slider_img', verbose_name='图片地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Teacher_avatar', verbose_name='讲师头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lessonid', models.CharField(max_length=255, verbose_name='课程id')),
                ('title', models.CharField(max_length=255, verbose_name='标题')),
                ('img', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='UserLesson_img', verbose_name='图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='pic', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', tyadmin_api_cli.fileds.SImageField(default='', max_length=255, upload_to='', verbose_name='问题图标')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', tyadmin_api_cli.fileds.SImageField(default='', max_length=255, upload_to='Qa_avatar', verbose_name='提问者头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lessonid', models.CharField(max_length=255, verbose_name='课程id')),
                ('img', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='', verbose_name='封面图')),
                ('title', models.CharField(max_length=255, verbose_name='标题')),
                ('price', models.IntegerField(default=0, verbose_name='价格')),
                ('isDiscount', models.BooleanField(verbose_name='是否优惠')),
                ('discountPrice', models.IntegerField(default=0, verbose_name='折后价格')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduction', models.CharField(default='', max_length=255, verbose_name='课程介绍')),
                ('img', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Lesson_img', verbose_name='课程图片')),
                ('banner', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Lesson_banner', verbose_name='课程Banner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Integral_img', verbose_name='图片')),
                ('title', models.CharField(max_length=255, verbose_name='标题')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', tyadmin_api_cli.fileds.SImageField(max_length=255, upload_to='Article_img', verbose_name='图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', tyadmin_api_cli.fileds.SImageField(default='https://static.mukewang.com/static/img/avatar_default.png', max_length=255, upload_to='User_avatar', verbose_name='头像')),
