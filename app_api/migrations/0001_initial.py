    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.IntegerField(default=0, verbose_name='文章code')),
            ],
            options={
                'verbose_name': '文章类型',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', app_api.models.ImageField(default='', help_text='$显示头像$', max_length=255, upload_to='Comment_avatar', verbose_name='评论头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(help_text='$显示图片$', max_length=255, upload_to='', verbose_name='图标')),
            ],
            options={
                'verbose_name': '首页左侧菜单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='Read_img', verbose_name='图片')),
                ('detailImg', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='Read_detail', verbose_name='细节图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255, verbose_name='章节标题')),
                ('read', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, related_name='chapter', to='app_api.read', verbose_name='所属专栏')),
            ],
            options={
                'verbose_name': '专栏章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='Slider_img', verbose_name='图片地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', app_api.models.ImageField(help_text='$显示头像$', max_length=255, upload_to='Teacher_avatar', verbose_name='讲师头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messageid', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, related_name='notice', to='app_api.notice', verbose_name='通知id')),
            ],
            options={
                'verbose_name': '用户通知',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lessonid', models.CharField(max_length=255, verbose_name='课程id')),
                ('title', models.CharField(max_length=255, verbose_name='标题')),
                ('img', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='UserLesson_img', verbose_name='图片')),
                ...
                ('type', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.lessontype', verbose_name='课程类型')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, related_name='term', to='app_api.chapter', verbose_name='所属章节')),
            ],
            options={
                'verbose_name': '小节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', app_api.models.ImageField(help_text='$显示头像$', max_length=255, upload_to='pic', verbose_name='头像')),
                ('name', models.CharField(max_length=255, verbose_name='名称')),
                ('number', models.IntegerField(default=0, verbose_name='积分数')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.studenttype', verbose_name='学生类型')),
            ],
            options={
                'verbose_name': '学生',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.rechargeaction', verbose_name='RechargeAction')),
                ('way', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.rechargepay', verbose_name='RechargePay')),
            ],
            options={
                'verbose_name': '充值记录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('read_chapter', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, related_name='chapter_item', to='app_api.readchapter', verbose_name='所属章节')),
            ],
            options={
                'verbose_name': '专栏章节小节',
        ...
        migrations.AddField(
            model_name='read',
            name='author',
            field=models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__name', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.teacher', verbose_name='作者'),
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ...
                ('icon', app_api.models.ImageField(default='', help_text='$显示图片$', max_length=255, upload_to='', verbose_name='问题图标')),
                ('isResolve', models.BooleanField(verbose_name='问题是否解决')),
                ('tags', models.ManyToManyField(blank=True, db_constraint=False, default=None, help_text='$显示字段$__text', to='app_api.Label', verbose_name='问题拥有的label')),
            ],
            options={
                'verbose_name': '问题',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', app_api.models.ImageField(default='', help_text='$显示头像$', max_length=255, upload_to='Qa_avatar', verbose_name='提问者头像')),
                ...
                ('time', models.DateTimeField(auto_now=True, verbose_name='评论时间')),
                ('comment', models.CharField(default='', max_length=1000, verbose_name='评论内容')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.qatype', verbose_name='问题类型')),
            ],
            options={
                'verbose_name': 'Qa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isDiscount', models.BooleanField(verbose_name='是否优惠')),
                ('discountPrice', models.IntegerField(default=0, verbose_name='折后价格')),
                ('order', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__code', on_delete=django.db.models.deletion.DO_NOTHING, related_name='list', to='app_api.order', verbose_name='所属订单')),
            ],
            options={
                'verbose_name': '订单小项',
        ...
        migrations.AddField(
            model_name='order',
            name='status',
            field=models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, related_name='list', to='app_api.orderstatus', verbose_name='订单状态'),
        ),
        migrations.AddField(
            model_name='order',
            name='way',
            field=models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='list', to='app_api.rechargepay', verbose_name='支付方式'),
        ),
        migrations.CreateModel(
            name='Log',
            fields=[
                ...
                ('type', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.logtype', verbose_name='日志类型')),
            ],
            options={
                'verbose_name': '访问日志',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduction', models.CharField(default='', max_length=255, verbose_name='课程介绍')),
                ('img', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='Lesson_img', verbose_name='课程图片')),
                ('banner', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='Lesson_banner', verbose_name='课程Banner')),
                ...
                ('category', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.labeltype', verbose_name='课程分类')),
                ('hard', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.lessonhardtype', verbose_name='课程难度类型')),
                ('labels', models.ManyToManyField(blank=True, db_constraint=False, default=None, help_text='$显示字段$__title', to='app_api.Label', verbose_name='课程拥有的label')),
                ('script', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.lessonscript', verbose_name='课程角标')),
                ('teacher', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__name', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.teacher', verbose_name='课程讲师')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.lessontype', verbose_name='课程类型')),
            ],
            options={
                'verbose_name': '课程',
        ...
        migrations.AddField(
            model_name='label',
            name='type',
            field=models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.labeltype', verbose_name='Label类型'),
        ),
        migrations.CreateModel(
            name='Integral',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='Integral_img', verbose_name='图片')),
                ('title', models.CharField(max_length=255, verbose_name='标题')),
                ('integral', models.IntegerField(default=0, verbose_name='积分数')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.integraltype', verbose_name='积分商品类型')),
            ],
            options={
                'verbose_name': '积分商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('range', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.couponrange', verbose_name='优惠券使用范围')),
                ('status', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.couponstatus', verbose_name='优惠券使用状态')),
            ],
            options={
                'verbose_name': '优惠券',
        ...
        migrations.AddField(
            model_name='chapter',
            name='lesson',
            field=models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.lesson', verbose_name='所属Lesson'),
        ),
        migrations.CreateModel(
            name='Bill',
            fields=[
                ...
                ('way', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__text', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.rechargepay', verbose_name='账单支方式')),
            ],
            options={
                'verbose_name': 'Bill',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', app_api.models.ImageField(help_text='$显示图片$', max_length=255, upload_to='Article_img', verbose_name='图片')),
                ...
                ('time', models.CharField(max_length=255, verbose_name='时间')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, default='', help_text='$显示字段$__title', on_delete=django.db.models.deletion.DO_NOTHING, to='app_api.articletype', verbose_name='文章类型')),
            ],
            options={
                'verbose_name': '文章',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', app_api.models.ImageField(default='https://static.mukewang.com/static/img/avatar_default.png', help_text='$显示头像$', max_length=255, upload_to='User_avatar', verbose_name='头像')),
