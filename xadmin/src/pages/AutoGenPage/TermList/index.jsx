...
import {addTerm, queryTerm, removeTerm, updateTerm} from './service';
import UpdateForm from './components/UpdateForm';
import UploadAvatar from '@/components/UploadAvatar';
import {queryChapter} from '@/pages/AutoGenPage//ChapterList/service';
...
const TableList = () => {
  ...
  const base_columns = [{
            ...
            const children = chapterForeignKeyList.map((item) => {
  ...
  const [chapterForeignKeyList, setChapterForeignKeyList] = useState([]);
      useEffect(() => {
        queryChapter().then(value => {
          setChapterForeignKeyList(value.data);
        });
      }, []);
