...
import {addReadChapter, queryReadChapter, removeReadChapter, updateReadChapter} from './service';
import UpdateForm from './components/UpdateForm';
import UploadAvatar from '@/components/UploadAvatar';
import {queryRead} from '@/pages/AutoGenPage//ReadList/service';
...
const TableList = () => {
  ...
  const base_columns = [{
            ...
            const children = readForeignKeyList.map((item) => {
  ...
  const [readForeignKeyList, setReadForeignKeyList] = useState([]);
      useEffect(() => {
        queryRead().then(value => {
          setReadForeignKeyList(value.data);
        });
      }, []);
