...
import {addUserCourse, queryUserCourse, removeUserCourse, updateUserCourse} from './service';
...
const TableList = () => {
  ...
  try {
    await updateUserCourse(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索用户课程 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryUserCourse({...params, sorter, filter})}
