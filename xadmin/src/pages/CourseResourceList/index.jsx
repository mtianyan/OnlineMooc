...
import {addCourseResource, queryCourseResource, removeCourseResource, updateCourseResource} from './service';
...
const TableList = () => {
  ...
  try {
    await updateCourseResource(value, current_id);
    hide();
  ...
  try {
    ...
    await removeCourseResource(ids);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索课程资源 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryCourseResource({...params, sorter, filter})}
