...
import {addUserAsk, queryUserAsk, removeUserAsk, updateUserAsk} from './service';
...
const TableList = () => {
  ...
  try {
    await updateUserAsk(value, current_id);
    hide();
  ...
  return (
    <PageHeaderWrapper>
      <ProTable
        ...
        request={(params, sorter, filter) => queryUserAsk({...params, sorter, filter})}
