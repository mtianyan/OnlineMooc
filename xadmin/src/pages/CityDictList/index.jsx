...
import {addCityDict, queryCityDict, removeCityDict, updateCityDict} from './service';
...
const TableList = () => {
  ...
  try {
    await updateCityDict(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索城市 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryCityDict({...params, sorter, filter})}
