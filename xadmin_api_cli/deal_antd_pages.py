...
from django.db.models import ForeignKey, CharField, DateTimeField, DateField, BooleanField, IntegerField, FloatField, FileField
from xadmin_api_cli.contants import MAIN_DISPLAY, MAIN_AVATAR, MAIN_PIC
from xadmin_api_cli.fileds import richTextField, ImageField
        ...
        query$关联Model$().then(value => {
          ...
          return <Switch checked={is_value} onClick={(checked) => {
            form.setFieldsValue({'%s': checked});
                ...
                elif isinstance(filed, ImageField):
